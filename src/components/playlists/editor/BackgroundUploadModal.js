...
export default function BackgroundUploadModal({
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-bold mb-4">Upload Background Image</h2>
          ...
          <div className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-600 rounded-lg cursor-pointer bg-gray-700/50 hover:bg-gray-700/70 transition">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p className="text-sm text-gray-400">
                {newBackground ? newBackground.name : "Click to upload background image"}
              </p>
            </div>
            <input 
              type="file" 
